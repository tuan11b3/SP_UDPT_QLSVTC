USE [QLSVTC]
GO
/****** Object:  StoredProcedure [dbo].[SP_REPORT_PHIEU_DIEM_SV]    Script Date: 11/21/2024 1:08:11 PM ******/
SET ANSI_NULLS ON
GO
...
BEGIN
    ...
    FROM 
        (SELECT MALTC, DIEM_CC, DIEM_GK, DIEM_CK FROM DANGKY WHERE MASV = @MASV) AS FilteredDANGKY          
    INNER JOIN 
