...
/****** Object:  StoredProcedure [dbo].[SP_REPORT_DS_LOPTINCHI]    Script Date: 12/11/2024 12:43:49 PM ******/
SET ANSI_NULLS ON
GO
...
CREATE PROCEDURE [dbo].[SP_REPORT_DS_LOPTINCHI] @NIENKHOA INT,      -- Niên khóa
    @HOCKY INT          -- Học kỳ
AS
BEGIN
    ...
    COUNT(sv.MASV) AS SOSVDANGKY            -- Số sinh viên đăng ký
	FROM 
