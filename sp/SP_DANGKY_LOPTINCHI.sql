...
/****** Object:  StoredProcedure [dbo].[SP_DANGKY_LOPTINCHI]    Script Date: 12/14/2024 10:37:21 AM ******/
SET ANSI_NULLS ON
GO
...
CREATE PROCEDURE [dbo].[SP_DANGKY_LOPTINCHI]
@MASV NCHAR(10),
@MALTC NCHAR(10)
AS
DECLARE @mankhk INT;
...
BEGIN
	...
	SELECT MATB 
	FROM (SELECT MALTC FROM DANGKY WHERE MASV = @MASV) FilteredDANGKY
